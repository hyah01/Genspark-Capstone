...
import com.genspark.cart_service.services.UserClient;
...
public class CartJwtAutFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public CartJwtAutFilter(CartJwtUtil jwtUtil, @Lazy CartUserInfoService userClient) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = cartUserInfoService.loadUserByUsername(username);
